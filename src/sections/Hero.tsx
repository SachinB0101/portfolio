...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-end pb-16 md:pb-20 px-5 md:px-8 pt-28 md:pt-32 relative overflow-hidden">
      ...
      <motion.div variants={container} initial="hidden" animate="show" className="max-w-7xl w-full">
        <motion.p variants={item} className="section-label mb-6 md:mb-8">
        ...
        >
          Building things<br />
          <span className="italic text-[#1a1a1a]/40">for the web.</span>
        </motion.h1>
        ...
        >
          CS grad from University of Manitoba. I build scalable, full-stack applications with React, TypeScript, and AWS — from pixel-perfect UIs to serverless backends.
        </motion.p>

        <motion.div variants={item} className="flex flex-wrap items-center gap-4 md:gap-6">
          <a
            href="#work"
